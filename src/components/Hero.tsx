export default function Hero({ isDarkMode }: { isDarkMode: boolean }) {
    return (
        <div id="home" className="flex flex-col items-center justify-center text-center min-h-[calc(100vh-80px)] px-4">
            ...
            <h3 className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto leading-relaxed text-gray-600 dark:text-gray-300">
                Desarrollador FullStack especializado en tecnologias web modernas
            </h3>
